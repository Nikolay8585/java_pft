...
public class SoapHelper {
    ...
    public BigInteger getStatus(int issueId) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        BigInteger issueStatus = mc.mc_issue_get("administrator", "root"
                , BigInteger.valueOf(issueId)).getStatus().getId();
        return issueStatus;
    }
}
